...
from .offer import Offer  # Asegúrate de que el archivo se llama offer.py y el modelo es Offer
...
class TransactionHistory(models.Model):
    ...
    offer = models.ForeignKey(Offer, on_delete=models.CASCADE, related_name='transaction_histories')
